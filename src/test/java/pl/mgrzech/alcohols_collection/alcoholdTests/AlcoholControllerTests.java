...
public class AlcoholControllerTests {
    ...
    public void init(){
        ...
        listAlcohols.add(new Alcohol(1, "name1", "type1", 50, 40, nowDate, nowDate, "comment1", new Manufacturer(), "", "A1", listPictures, "", false));
        listAlcohols.add(new Alcohol(2, "name2", "type2", 50, 40, nowDate, nowDate, "comment2", new Manufacturer(), "", "A2", listPictures, "", false));

        alcoholPage = new PageImpl<>(listAlcohols);
        correctAlcohol = new Alcohol(3, "name", "type", 50, 40, nowDate, nowDate, "comment", new Manufacturer(), "", "A1", listPictures, "", false);
    }
